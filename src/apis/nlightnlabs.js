...
export const pythonApp = async (appName) =>{
  console.log(appName)
  const response = await axios.post('/python/runApp', { appName })
...
export const pythonData = async (appName) =>{
  console.log(appName)
  const response = await axios.post('/python/getData', { appName })
